...
/* MIGRATEFINISH history */
#define MIGRATEFINISH_History NULL

/* MIGRATEFINISH tips */
#define MIGRATEFINISH_tips NULL

/********** MIGRATESCAN ********************/

/* MIGRATESCAN history */
#define MIGRATESCAN_History NULL

/* MIGRATESCAN tips */
#define MIGRATESCAN_tips NULL

/* MIGRATESCAN argument table */
struct redisCommandArg MIGRATESCAN_Args[] = {
...
/* MIGRATESTART history */
#define MIGRATESTART_History NULL

/* MIGRATESTART tips */
#define MIGRATESTART_tips NULL
...
{"migratefinish","Indicate KV migration finish.",NULL,NULL,CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_GENERIC,MIGRATEFINISH_History,MIGRATEFINISH_tips,migrateFinishCommand,1,CMD_WRITE,ACL_CATEGORY_KEYSPACE|ACL_CATEGORY_DANGEROUS},
{"migratescan","Scan function for KV migration.","O(1) for every call. O(N) for a complete iteration, including enough command calls for the cursor to return back to 0. N is the number of elements inside the collection.",NULL,CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_GENERIC,MIGRATESCAN_History,MIGRATESCAN_tips,migrateScanCommand,4,CMD_READONLY,ACL_CATEGORY_KEYSPACE,.args=MIGRATESCAN_Args},
{"migratestart","Indicate KV migration start.",NULL,NULL,CMD_DOC_NONE,NULL,NULL,COMMAND_GROUP_GENERIC,MIGRATESTART_History,MIGRATESTART_tips,migrateStartCommand,1,CMD_READONLY,ACL_CATEGORY_KEYSPACE},
